...
function placeWolfLayers(ctx, x) {
  ...
  w1_glow.onload = function () {
    ...
    w1_base.src = `https://lorwolf.azureedge.net/rawwolflayers/LayerImage_${$(
      "#w1-breed"
    ).val()}_1_${$("#w1-base-color").val()}_${$(
      "#w1-sex"
    ).val()}_5_${SIZE}.png`;
  };
  var w1_glowpath = $("#glownone").prop("checked")
    ? "./wolfassets/Empty/EMPTY.png"
    : $("#glowsoft").prop("checked")
    ? `./wolfassets/Glowline/LayerImage_${$("#w1-breed").val()}_1_1_${$(
        "#w1-sex"
      ).val()}_0_${SIZE}_GLOW.png`
    : `./wolfassets/Hardline/LayerImage_${$("#w1-breed").val()}_1_1_${$(
        "#w1-sex"
      ).val()}_0_${SIZE}_OUTLINE.png`;
  w1_glow.src = w1_glowpath;
  ...
  w2_glow.onload = function () {
    ...
    w2_base.src = `https://lorwolf.azureedge.net/rawwolflayers/LayerImage_${$(
      "#w2-breed"
    ).val()}_1_${$("#w2-base-color").val()}_${$(
      "#w2-sex"
    ).val()}_5_${SIZE}.png`;
  };
  var w2_glowpath = $("#glownone").prop("checked")
    ? "./wolfassets/Empty/EMPTY.png"
    : $("#glowsoft").prop("checked")
    ? `./wolfassets/Glowline/LayerImage_${$("#w2-breed").val()}_1_1_${$(
        "#w2-sex"
      ).val()}_0_${SIZE}_GLOW.png`
    : `./wolfassets/Hardline/LayerImage_${$("#w2-breed").val()}_1_1_${$(
        "#w2-sex"
      ).val()}_0_${SIZE}_OUTLINE.png`;
  w2_glow.src = w2_glowpath;
}
